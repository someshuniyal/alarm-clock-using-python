...
class clock(Frame):
    ...
    def set_stop_button(self):
        ...
        self.set_button=Button(self,bg="#ec7063",activebackground="#ec7063",activeforeground="white",text="Set",bd=0,fg="white",font=self.button_font,command=self.set_allarm)
        self.set_button.place(x=250,y=225,width=100,height=50)
        self.stop_button=Button(self,bg="#ec7063",text="Stop",activebackground="#ec7063",activeforeground="white",bd=0,fg="white",font=self.button_font,command=self.stop_allarm)
